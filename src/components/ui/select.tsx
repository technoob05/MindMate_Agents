...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex h-9 w-full items-center justify-between rounded-md border border-input px-3 py-2 text-sm shadow-sm ring-offset-background",
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.ScrollUpButton
    ...
    className={cn(
      ...
      "glass-morphism text-muted-foreground transition-colors",
      "hover:text-primary",
      className
    )}
    {...props}
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ...
    className={cn(
      ...
      "before:absolute before:inset-0 before:rounded-sm before:bg-gradient-to-r before:from-primary/5 before:to-transparent before:opacity-0",
