...
>(({ className, ...props }, ref) => (
  <MenubarPrimitive.Trigger
    ...
    className={cn(
      ...
      "glass-morphism",
      "before:absolute before:inset-0 before:rounded-sm before:bg-gradient-to-r before:from-primary/5 before:via-transparent before:to-transparent",
...
>(({ className, ...props }, ref) => (
  <MenubarPrimitive.SubContent
    ...
    className={cn(
      ...
      "glass-morphism bg-background/90 backdrop-blur-sm",
